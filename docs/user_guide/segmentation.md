...
:::{note}
There is an example file describing CNMF parameters at the root of this project.`.
:::
...
:::{tip}
In general, **If your indicator takes >1 frame to rise/decay, {code}`P`=2 (slow)**
otherwise, {code}`P`=1 (fast)
:::
