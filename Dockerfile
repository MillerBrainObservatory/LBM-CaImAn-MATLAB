...
# COPY THIS FOR CAIMAN TOOLBOXES
# docker build --build-arg MATLAB_RELEASE=r2024a
#              --build-arg MATLAB_PRODUCT_LIST="MATLAB Parallel_Computing_Toolbox Statistics_and_Machine_Learning_Toolbox"
#              --build-arg MATLAB_INSTALL_LOCATION="/opt/matlab/R2024a"
#              --build-arg LICENSE_SERVER=27000@rmatlab.rockefeller.edu
#              -t ml_caiman .
...
ARG MATLAB_PRODUCT_LIST="MATLAB Parallel_Computing_Toolbox Statistics_and_Machine_Learning_Toolbox"
...
ARG LICENSE_SERVER=27000@rmatlab.rockefeller.edu
...
ENV MLM_LICENSE_FILE=27000@rmatlab.rockefeller.edu
