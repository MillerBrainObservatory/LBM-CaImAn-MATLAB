classdef LineScanDisplay < handle
    ...
    methods
        function obj = LineScanDisplay(hSI,hFig,chan)
            ...
            if obj.is3d
                obj.hSpacialViewAx = axes('parent',obj.hSpacialViewPnl,'color','k','PlotBoxAspectRatio', ones(1,3),'XColor','w','YColor','w','ZColor','w',...
                ...
                obj.hSpacialViewAx = axes('parent',obj.hSpacialViewPnl,'position',[0 0 1 1],'color','k','XTick',[],'XTickLabel',[],'YTick',[],...
