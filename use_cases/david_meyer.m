...
parent_path = fullfile('C:\Users\RBO\Documents\data\david\20230808_R109_2p3x2p3mm_lrsc_ketamine\');
data_path = fullfile(parent_path);
save_path = fullfile(parent_path, sprintf('extracted'));
mc_path = fullfile(parent_path, sprintf('corrected'));
segment_path = fullfile(parent_path, sprintf('segmented'));
