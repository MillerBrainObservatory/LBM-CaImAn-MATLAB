function timeseries_to_tiff(varargin)
% TIMESERIES_TO_TIFF Write image to TIFF file with specified datatype.
%
% Parameters
% ----------
...
% timeseries_to_tiff(imgdata,header,'new_zplane_1.tif','uint16');
%
% imgdata = imread('mri.tif');
% timeseries_to_tiff(imgdata,[],'new_mri.tif','int32','Copyright','MRI',
% 'Compression',1);
%
...
tagstruct = getTagStructFromTiff(tiff_object);
