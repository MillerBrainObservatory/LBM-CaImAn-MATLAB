...
paths = {'\\v-storage2.rockefeller.edu\v-data2\jeff_demas\MAxiMuM_data\20200826\MH177_right_hemisphere_FOV_440mW_150__600um_depth_9min_dual_stimuli\';...
         '\\v-storage2.rockefeller.edu\v-data2\jeff_demas\MAxiMuM_data\20200825\MH178_both_6mm_FOV_440mW_150_600um_depth_9min_no_stimuli\';...
         '\\v-storage2.rockefeller.edu\v-data2\jeff_demas\MAxiMuM_data\20200904\MH182_left_2mm_FOV_415mW_150_600um_depth_9min_dual_stimuli\';...
         '\\v-storage2.rockefeller.edu\v-data2\jeff_demas\MAxiMuM_data\20200904\MH182_right_2mm_FOV_415mW_150_600um_depth_9min_dual_stimuli\'};
     
roots = {'MH177_right_hemisphere_FOV_440mW_150_600um_depth_9min_dual_stimuli_00001';...
         'MH178_both_6mm_FOV_440mW_150_600um_depth_9min_no_stimuli_00001';...
         'MH182_left_2mm_FOV_415mW_150_600um_depth_9min_dual_stimuli_00001';...
         'MH182_right_2mm_FOV_415mW_150_600um_depth_9min_dual_stimuli_00001'};
     
for j = 1:numExps
   if ~exist([paths{j} roots{j} '_00001.tif'],'file')
       error(['File ' num2str(j) ' does not exist.'])
   end
end
