...
load(fullfile(path,'pollen_sample_xy_calibration.mat'))
...
for m = 1:29
    ...
    p1 = load(fullfile(path, ['caiman_output_plane_' num2str(m) '.mat']),'Ym'); p1 = p1.Ym;
    p2 = load(fullfile(path, ['caiman_output_plane_' num2str(m+1) '.mat']),'Ym'); p2 = p2.Ym;
...
save(fullfile(path, 'three_neuron_mean_offsets.mat'),'offsets')