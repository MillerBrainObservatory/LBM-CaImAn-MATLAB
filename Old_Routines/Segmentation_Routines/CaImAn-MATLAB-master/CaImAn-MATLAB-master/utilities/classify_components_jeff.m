function [rval_space,rval_time,max_pr,sizeA,keep,fitness,traces] = classify_components_jeff(Y,A,C,b,f,YrA,options)
...
keep = ind_time & (max_pr > options.max_pr_thr) & (sizeA >= options.min_size_thr) & (sizeA <= options.max_size_thr);
