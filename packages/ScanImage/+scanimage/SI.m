classdef SI < scanimage.interfaces.Component & most.HasMachineDataFile & most.HasClassDataFile & dynamicprops
    ...
    properties (Hidden, GetAccess = {?scanimage.interfaces.Class, ?most.Model})
        ...
        cachedAcqProps = {'hPhotostim.logging', 'hChannels.loggingEnable', 'hScan2D.trigAcqTypeExternal', 'hFastZ.enable', 'hRoiManager.mroiEnable', 'hFastZ.waveformType' ,'hStackManager.numSlices', 'hStackManager.stackZStepSize', 'hStackManager.framesPerSlice'};
    ...
    properties(Transient,Constant)
        ...
        VERSION_MAJOR = '2018b';     % Version number
    ...
    methods (Hidden)
        function obj = SI(varargin)
            ...
            try
                ...
                %Initialize cameras component
                obj.hCameraManager = scanimage.components.CameraManager(obj);
