classdef ResScanPage < scanimage.guis.configuration.ConfigurationPage
    ...
    properties
        ...
        ADAPTER_MODULE_CHANNEL_COUNT = containers.Map({'','NI5732','NI5733','NI5734','NI5751','NI517x','NI5771'},{2,2,2,4,4,4,4});
    end
    ...
    methods
        function obj = ResScanPage(hConfigEditor, scannerName, create)
            ...
            obj.hBitfileVersionText = uicontrol(...
                ...
                'Style', 'text', ...
                'String', 'Custom Signal Conditioning Option', ...
                'HorizontalAlignment', 'left', ...
                'Units', 'pixels', ...
                'Position', [46 ph-1076 200 14],...
                'visible','off');
        
            obj.hBitfileVersionIDPopUp = most.gui.popupMenuEdit(...
                'parent', obj.hPanel, ...
                'Position', [280 ph-1078 150 22],...
        ...
        function reload(obj,scannerName)
            ...
            if isfield(mdfData, 'customSigCondOption') && ~isempty(mdfData.customSigCondOption)
                choicemask = regexpi(obj.hBitfileVersionIDPopUp.choices,mdfData.customSigCondOption);
        ...
        function s = getNewVarStruct(obj)
            ...
            if (numel(rio) > 1) && isempty(strfind(rio{2},'not found'))
                ...
                if numel(fpgaDig) > 1
                    ...
                    chc = obj.hBitfileVersionIDPopUp.string;
                    if ~isempty(chc) && ~strcmp(chc, 'None')
                        s.customSigCondOption = obj.hBitfileVersionIDPopUp.string;
                    end
                else
    ...
    methods
        function set.acqDev(obj, v)
            ...
            if any(mask)
                ...
                obj.hBitfileVersionIDPopUp.choices = [{'None'} ops];
