    ...
    methods (Hidden)
        function obj = SIController(hModel)
            ...
            visibleGuis = {'mainControlsV4' 'configControlsV4' 'imageControlsV4'...
                'channelControlsV4' 'scanimage.guis.statuswindow.StatusWindow'};
...
%                 end
        ...
        function ziniPhotonCountingCtrls(obj)
            ...
            if ~isempty(hFpga) && isprop(hFpga,'fifo_NI5771SampleToHost')
                ...
                obj.h5771SamplerListener{end+1} = addlistener(hScan2D,'uniformSampling','PostSet',@obj.changedPhotonCountingCtrls);
                obj.h5771SamplerListener{end+1} = addlistener(hScan2D,'maskDisableAveraging','PostSet',@obj.changedPhotonCountingCtrls);
