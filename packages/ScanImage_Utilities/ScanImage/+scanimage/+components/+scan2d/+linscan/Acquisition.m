    ...
    methods
        function start(obj)
            ...
            if strcmp(obj.hLinScan.hAcq.hAI.streamMode,'fpga')
                obj.hFpga.LinScanDivertSamples = obj.hLinScan.mdfData.LaserTriggerSampleMaskEnable;
                obj.hFpga.ResScanFilterSamples = false;
                obj.hFpga.LaserTriggerDelay = obj.hLinScan.mdfData.LaserTriggerSampleWindow(1);
                obj.hFpga.LaserSampleWindowSize = obj.hLinScan.mdfData.LaserTriggerSampleWindow(2);
                obj.hFpga.LaserTriggerFilterTicks = obj.hLinScan.mdfData.LaserTriggerFilterTicks;
            end
        ...
        function updateBufferedOffsets(obj)
            if ~isempty(obj.acqParamBuffer)
                if ~obj.useFpgaOffset
                    ...
                    obj.hFpga.AcqParamLiveChannelOffsets(1:N) = -obj.hLinScan.hSI.hChannels.channelOffset;
        ...
        function bufferAcqParams(obj,live,keepOld)
            ...
            if obj.isLineScan
                ...
                if obj.hLinScan.recordScannerFeedback
                    ...
                    obj.rec3dPath = obj.is3dLineScan && obj.zFdbkEn; % This will always be false because zFdbkEn is not set to true until ziniPrepareZFeedbackTask is run. This function, bufferAcqParams, runs first
