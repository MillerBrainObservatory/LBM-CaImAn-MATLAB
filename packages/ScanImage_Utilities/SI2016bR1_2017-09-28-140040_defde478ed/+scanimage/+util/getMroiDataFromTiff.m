function [roiData, roiGroup, header, imageData] = getMroiDataFromTiff(varargin)
...
%       
    ...
    if nargin == 1 || nargin == 2
        ...
        [header, imageData] = scanimage.util.opentif(varargin{1});
    else
                ...
                for roiIdx = roiIds
                    ...
                    if numImageCategories == 4
                        roiData{roiIdx}.imageData{currChan}{currVol}{roiImageCnt(roiIdx)} = ...
                            imageData(imgOffsetY+roiImgHeightRange, imgOffsetX+roiImgWidthRange,currChan,currVol);
                    else
                        roiData{roiIdx}.imageData{currChan}{currVol}{roiImageCnt(roiIdx)} = ...
                            imageData(imgOffsetY+roiImgHeightRange, imgOffsetX+roiImgWidthRange,currChan,1,currSlc,currVol);
                    end
                    cnt = cnt+1;
                end
            end
